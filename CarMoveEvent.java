...
public class CarMoveEvent extends SimulationEvent {
    private Car car;
    private double distanceToMove; // Or target position

    public CarMoveEvent(double time, Car car, double distanceToMove) {
        super(time);
        this.car = car;
